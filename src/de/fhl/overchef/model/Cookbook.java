...
public class Cookbook {
	 ...
	 * 
	 * @param rs
	 *            the result set for the recipes
	 * @return
	 * @throws SQLException
	 ...
	 * @throws IOException
	 */
	public List<Recipe> loadRecipesFromDB(ResultSet rs)
	 ...
	 * 
	 * @param rs
	 *            result set for the ingredients
	 * @param r
	 *            the recipe
	 * @throws SQLException
	 * @throws InstantiationException
	 * @throws IllegalAccessException
	 */
	public void loadIngredientFromDB(ResultSet rs, Recipe r)
	 ...
	 * 
	 * @param rs
	 *            result set storing names of pictures
	 * @param r
	 *            the recipe
	 * @throws SQLException
	 * @throws FileNotFoundException
	 ...
	 * 
	 * @param rs
	 *            result set for preparation step
	 * @param r
	 *            the recipe
	 * @throws SQLException
	 */
