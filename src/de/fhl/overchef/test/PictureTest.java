...
public class PictureTest {
	...
	public void setUp() throws Exception {
		picture = new Picture(System.getProperty("user.dir") + "\\src\\de\\fhl\\overchef\\view\\recipeViewPicture\\testpicture.PNG");
	}
	...
	public void testCheckName() throws FileNotFoundException, IOException {
		assertTrue(Picture.checkName(System.getProperty("user.dir") + "/src/de/fhl/overchef/model/Pictures/IMG_3578.PNG"));
		assertFalse(Picture.checkName(System.getProperty("user.dir") + "/src/de/fhl/overchef/model/Pictures/OverChefDefaultPicture.jpg"));
	}
